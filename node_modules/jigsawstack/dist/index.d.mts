...
interface AIScrapeResponse extends ScrapeResponse {
...
declare class Audio {
    ...
    speaker_voice_accents: () => Promise<any>;
}
...
interface SpamCheckValidationArrayResponse {
    success: boolean;
    check: {
        is_spam: boolean;
        score: number;
